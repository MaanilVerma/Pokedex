...
export const PokemonModalOverlay = styled.div<{ color: string }>`
  width: 100%;
  height: 100%;
  border-radius: 1.5rem;
  position: absolute;
...
export const PokemonModalData = styled.div`
  display: flex;
...
export const PokemonModalImg = styled.div`
  position: absolute;
  top: -9.38rem;
  left: 2.5rem;
...
export const PokemonModalNumber = styled.span`
  font-size: 1.25rem;
  line-height: 135%;
  font-weight: 700;
`;

export const PokemonModalType = styled.div`
  display: flex;
  gap: 0.5rem;
...
export const PokemonModalName = styled.span`
  font-size: 2rem;
  line-height: 135%;
  font-weight: 700;
...
export const PokemonModalFeatures = styled.div`
  display: flex;
  gap: 1.5rem;
  margin-top: 1.5rem;
...
export const PokemonModalWeight = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
...
export const PokemonModalHeight = styled(PokemonModalWeight)``;

export const PokemonModalDivider = styled.div`
  display: flex;
  flex-direction: column;
  gap: 1.5rem;
